        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EditorSince = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesAuthors", x => new { x.CategoryId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_CategoriesAuthors_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CategoriesAuthors_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersBooks", x => new { x.BookId, x.ApplicationUserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersBooks_BooksStatus_BookStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesAuthors_AuthorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersBooks_ApplicationUserId",
                table: "UsersBooks",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersBooks_BookStatusId",
                table: "UsersBooks",
                column: "BookStatusId");
        }
